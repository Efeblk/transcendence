class Game {
    ...
    animate() {
        ...
        if (this.aiPaddle) {
            this.aiPaddle.update(this.ball); // Update AI paddle if present
        }
    ...
    checkCollisions() {
        ...
        if (this.aiPaddle && this.ball.isCollidingWith(this.aiPaddle)) {
            this.ball.bounce();
    ...
    reset() {
        ...
        if (this.aiPaddle) this.aiPaddle.mesh.position.x = 0; // Reset AI paddle position
        this.playerScore = 0;
        this.aiScore = 0;
    }
    ...
    start(mode) {
        ...
        if (['easy', 'medium', 'hard'].includes(mode) && this.aiPaddle) {
            switch (mode) {
                case 'easy':
            ...
            console.log(`Game started in ${mode} mode with AI speed: ${this.aiPaddle.speed}`);
        }
